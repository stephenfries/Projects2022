...
* Replace "**TypeStreamerNameHere**" with a **Twitch Streamer Username** (separate multiple with a comma and no space after shroud,summit1g,etc) - make sure you don't remove the "**stream_name=**"
* Save **config.env**
